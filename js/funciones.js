		...
		var validation = Array.prototype.filter.call(forms, function(form) {
			form.addEventListener('submit', function(event) {
				...
				if (form.checkValidity() === false) {
					...
					$('form.needs-validation').append('<div class="my-3 text-center aviso-ajax"><i class="fas fa-circle-notch fa-spin fa-3x"></i></div>');
					...
					.fail(function(jqXHR, textStatus ){
						...
						$('form.needs-validation').append('<div class="alert alert-danger my-3 lead aviso-ajax" role="alert"><i class="fas fa-times fa-lg"></i> Error en el envío. '+textStatus+'</div>').hide().fadeIn();
